...
# ==============================================================================
# Base addresses from tibianic-dll:
# PLAYER_SKILLS_BEGIN_ADDRESS = 0x005C67F8 -> Offset: 0x1C67F8
# PLAYER_SKILLS_PERCENT_BEGIN_ADDRESS = 0x005C67DC -> Offset: 0x1C67DC
# Order: Fist(0), Club(1), Sword(2), Axe(3), Distance(4), Shield(5), Fishing(6)

# Skill Levels
OFFSET_SKILL_FIST     = 0x1C67F8
OFFSET_SKILL_CLUB     = 0x1C67FC
OFFSET_SKILL_SWORD    = 0x1C6800
OFFSET_SKILL_AXE      = 0x1C6804
OFFSET_SKILL_DISTANCE = 0x1C6808
OFFSET_SKILL_SHIELD   = 0x1C680C
OFFSET_SKILL_FISHING  = 0x1C6810

# Skill Percentages
OFFSET_SKILL_FIST_PCT     = 0x1C67DC
OFFSET_SKILL_CLUB_PCT     = 0x1C67E0
OFFSET_SKILL_SWORD_PCT    = 0x1C67E4
OFFSET_SKILL_AXE_PCT      = 0x1C67E8
OFFSET_SKILL_DISTANCE_PCT = 0x1C67EC
OFFSET_SKILL_SHIELD_PCT   = 0x1C67F0
OFFSET_SKILL_FISHING_PCT  = 0x1C67F4
