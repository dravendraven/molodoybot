...
class PathPreviewWindow(ctk.CTkToplevel):
    def __init__(self, parent, image_paths, title="Visualização de Rota"):
        ...
        for img_path in image_paths:
            if os.path.exists(img_path):
                try:
                    ...
                    # 2. Cria o objeto CTkImage (importante passar o size exato)
                    # Se o mapa for MUITO grande, talvez queira aplicar um downscale aqui,
                    # mas geralmente queremos ver detalhes (pixels reais).
        ...
        # Botão Fechar
        self.btn_close = ctk.CTkButton(self, text="Fechar", command=self.destroy, fg_color="#C0392B", hover_color="#E74C3C")
